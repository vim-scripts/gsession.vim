...
VIMLIB = ./
VIMMETA = META
TO_INST_VIMS = plugin/gsession.vim
VIMS_TO_RUNT = plugin/gsession.vim \
	$(VIM_BASEDIR)/plugin/gsession.vim
...
link : 
		$(NOECHO) $(LN_S) $(PWD)/plugin/gsession.vim $(VIM_BASEDIR)/plugin/gsession.vim

link-force : 
		$(NOECHO) $(LN_SF) $(PWD)/plugin/gsession.vim $(VIM_BASEDIR)/plugin/gsession.vim

unlink : 
		$(NOECHO) $(RM) $(VIM_BASEDIR)/plugin/gsession.vim
